...
// 📋 Reserva interface (extended to include pending status for consistency)
interface Reserva {
  id: number;
  local: string;
  mesaNumero: string;
...
export default function ConfirmedReservations() {
  ...
  const reservasConfirmadas = reservas.filter((reserva) => reserva.estado === "confirmed");
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        {reservasConfirmadas.length === 0 ? (
          <Text style={styles.noReservationsText}>No hay reservas confirmadas.</Text>
        ) : (
            ...
            <View key={reserva.id} style={styles.card}>
              <View style={styles.cardHeader}>
                ...
                <View style={[styles.estadoEtiqueta, { backgroundColor: Colores.azul }]}>
                  <Text style={styles.estadoTexto}>Confirmadas</Text>
                </View>
              </View>
...
// 💅 Estilos (adapted from Historial, using only blue, white, and black)
